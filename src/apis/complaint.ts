import { Complaint, DashboardData, DetailMessInfo, MessInfo } from "../interfaces"
...
export async function getComplaint(token: string, complaintId: number): Promise<DetailMessInfo | null> {
