...
export async function createComplaint(
  ...
  try {
    const resp = await fetch(BACKEND_URL + "/complaint", {
      method: "POST",
      headers: {
...
export async function getDashboard(
  ...
  try {
    const resp = await fetch(BACKEND_URL + "/complaint/dashboard", {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bearer ${token}`,
...
export async function getComplaints(
  ...
  try {
    const resp = await fetch(
      BACKEND_URL +
        `/complaint?page=1&limit=100&sortBy=createdAt&status=${status}`,
      {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
...
export async function getComplaint(
  token: string,
  complaintId: number
): Promise<DetailMessInfo | null> {
  try {
    const resp = await fetch(BACKEND_URL + `/complaint/${complaintId}`, {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bearer ${token}`,
    ...
    const jsn: DetailMessInfo = await resp.json();
    console.log(jsn);
